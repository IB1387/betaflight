...
#define TRANSPONDER_DMA_BUFFER_SIZE 493 // = 5050 (length of longest code / 50)
#define BIT_TOGGLE_1 78 // (156 / 2) = half timer period
#define BIT_TOGGLE_0 0
#define NUM_PERIODS_0 5 // 5 * 50 = 250us
#define NUM_PERIODS_1 13 // 13 * 50 = 650us
